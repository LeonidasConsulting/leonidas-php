...
<section style="max-width:800px;margin:8rem auto;padding:0 1.5rem;text-align:center;">
  ...
  <a href="<?= $b ?>/" style="display:inline-flex;align-items:center;gap:0.5rem;padding:0.875rem 2rem;background:#D4A843;color:#0A0A1A;font-weight:700;font-size:0.9rem;border-radius:0.5rem;text-decoration:none;">← Back to Home</a>
</section>
