      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="service-card fade-in">
          <div class="flex items-center gap-4 mb-5">
            ...
            <div>
              <a href="<?= $b ?>/services/managed-it" style="text-decoration:none; cursor:pointer;"><h3 style="font-size:1.2rem; font-weight:800; color:#FFFFFF; transition:color 0.2s;" onmouseover="this.style.color='#D4A843'" onmouseout="this.style.color='#FFFFFF'">Managed IT Services</h3></a>
          ...
          <a href="<?= $b ?>/services/managed-it" class="learn-more mt-4 inline-flex items-center gap-2 text-sm font-semibold" style="color:#D4A843;">Learn more <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M2 7h10M8 3l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
        </div>
        ...
        <div class="service-card fade-in fade-in-delay-1">
          <div class="flex items-center gap-4 mb-5">
            ...
            <div>
              <a href="<?= $b ?>/services/cybersecurity" style="text-decoration:none; cursor:pointer;"><h3 style="font-size:1.2rem; font-weight:800; color:#FFFFFF; transition:color 0.2s;" onmouseover="this.style.color='#D4A843'" onmouseout="this.style.color='#FFFFFF'">Cybersecurity</h3></a>
          ...
          <a href="<?= $b ?>/services/cybersecurity" class="learn-more mt-4 inline-flex items-center gap-2 text-sm font-semibold" style="color:#D4A843;">Learn more <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M2 7h10M8 3l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
        </div>
        ...
        <div class="service-card fade-in">
          <div class="flex items-center gap-4 mb-5">
            ...
            <div>
              <a href="<?= $b ?>/services/network-engineering" style="text-decoration:none; cursor:pointer;"><h3 style="font-size:1.2rem; font-weight:800; color:#FFFFFF; transition:color 0.2s;" onmouseover="this.style.color='#D4A843'" onmouseout="this.style.color='#FFFFFF'">Network Engineering</h3></a>
        ...
        <div class="service-card fade-in fade-in-delay-1">
          <div class="flex items-center gap-4 mb-5">
            ...
            <div>
              <a href="<?= $b ?>/services/unified-communications" style="text-decoration:none; cursor:pointer;"><h3 style="font-size:1.2rem; font-weight:800; color:#FFFFFF; transition:color 0.2s;" onmouseover="this.style.color='#D4A843'" onmouseout="this.style.color='#FFFFFF'">Unified Communications &amp; VoIP</h3></a>
          ...
          <a href="<?= $b ?>/services/unified-communications" class="learn-more mt-4 inline-flex items-center gap-2 text-sm font-semibold" style="color:#D4A843;">Learn more <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M2 7h10M8 3l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
        </div>
        ...
        <div class="service-card fade-in">
          <div class="flex items-center gap-4 mb-5">
            ...
            <div>
              <a href="<?= $b ?>/services/telecom-wan" style="text-decoration:none; cursor:pointer;"><h3 style="font-size:1.2rem; font-weight:800; color:#FFFFFF; transition:color 0.2s;" onmouseover="this.style.color='#D4A843'" onmouseout="this.style.color='#FFFFFF'">Telecom &amp; WAN Solutions</h3></a>
          ...
          <a href="<?= $b ?>/services/telecom-wan" class="learn-more mt-4 inline-flex items-center gap-2 text-sm font-semibold" style="color:#D4A843;">Learn more <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M2 7h10M8 3l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
        </div>
        ...
        <div class="service-card fade-in fade-in-delay-1">
          <div class="flex items-center gap-4 mb-5">
            ...
            <div>
              <a href="<?= $b ?>/services/desktop-support" style="text-decoration:none; cursor:pointer;"><h3 style="font-size:1.2rem; font-weight:800; color:#FFFFFF; transition:color 0.2s;" onmouseover="this.style.color='#D4A843'" onmouseout="this.style.color='#FFFFFF'">Desktop Support</h3></a>
          ...
          <a href="<?= $b ?>/services/desktop-support" class="learn-more mt-4 inline-flex items-center gap-2 text-sm font-semibold" style="color:#D4A843;">Learn more <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M2 7h10M8 3l4 4-4 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
        </div>
  ...
  <section class="py-28 px-6" style="background:rgba(5,5,16,0.8);">
    <div class="max-w-3xl mx-auto text-center fade-in">
      ...
      <div class="flex flex-wrap gap-4 justify-center mt-10">
        <a href="<?= $b ?>/contact" class="btn-primary">Contact Leonidas <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
